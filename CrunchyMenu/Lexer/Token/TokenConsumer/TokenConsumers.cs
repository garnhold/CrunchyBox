...
namespace Crunchy.Menu
{
    static public class TokenConsumers
    {
        ...
        static public TokenConsumer ModePusher(TokenModeDefinition token_mode_definition)
        {
            return new TokenConsumer_ModePusher(token_mode_definition);
        }
        static public TokenConsumer ModePopper(TokenModeDefinition token_mode_definition)
        {
