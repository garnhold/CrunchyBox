...
{
    static public class SerializedPropertyExtensions_Value
    {
		static public void ClearValue(this SerializedProperty item)
		{
			switch(item.propertyType)
			{
				case SerializedPropertyType.Generic:
                    item.GetImmediateChildren(true).Process(c => c.ClearValue());
                    break;
		...
		static public void SetValue(this SerializedProperty item, object value)
		{
			...
			{
				case SerializedPropertyType.Generic:
                    item.objectReferenceValue = value.Convert<UnityEngine.Object>();
                    break;
