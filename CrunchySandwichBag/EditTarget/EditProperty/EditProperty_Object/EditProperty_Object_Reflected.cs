...
{
    public class EditProperty_Object_Reflected : EditProperty_Object
    {
        private ReflectedProperty_Object property;

        public EditProperty_Object_Reflected(EditTarget t, ReflectedProperty_Object p) : base(t)
        {
            property = p;
        }
