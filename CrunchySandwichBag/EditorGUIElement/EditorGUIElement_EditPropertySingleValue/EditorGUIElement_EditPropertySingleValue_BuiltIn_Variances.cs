...
namespace CrunchySandwichBag
{
    ...
    public class EditorGUIElement_EditPropertySingleValue_BuiltIn_IntVariance : EditorGUIElement_EditPropertySingleValue_BuiltIn<IntVariance>
    {
        ...
        public EditorGUIElement_EditPropertySingleValue_BuiltIn_IntVariance(EditProperty_Single_Value p) : base(p) { }
    }

	[EditorGUIElementForType(typeof(FloatVariance), true)]
    public class EditorGUIElement_EditPropertySingleValue_BuiltIn_FloatVariance : EditorGUIElement_EditPropertySingleValue_BuiltIn<FloatVariance>
    {
        ...
        public EditorGUIElement_EditPropertySingleValue_BuiltIn_FloatVariance(EditProperty_Single_Value p) : base(p) { }
    }
