...
namespace CrunchySandwichBag
{
    ...
    public class EditorGUIElement_EditPropertySingleValue_BuiltIn_IntRange : EditorGUIElement_EditPropertySingleValue_BuiltIn<IntRange>
    {
        ...
        public EditorGUIElement_EditPropertySingleValue_BuiltIn_IntRange(EditProperty_Single_Value p) : base(p) { }
    }

	[EditorGUIElementForType(typeof(FloatRange), true)]
    public class EditorGUIElement_EditPropertySingleValue_BuiltIn_FloatRange : EditorGUIElement_EditPropertySingleValue_BuiltIn<FloatRange>
    {
        ...
        public EditorGUIElement_EditPropertySingleValue_BuiltIn_FloatRange(EditProperty_Single_Value p) : base(p) { }
    }
