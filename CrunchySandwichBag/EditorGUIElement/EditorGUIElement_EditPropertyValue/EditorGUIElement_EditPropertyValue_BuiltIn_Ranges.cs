...
namespace CrunchySandwichBag
{
    ...
    public class EditorGUIElement_EditPropertyValue_BuiltIn_IntRange : EditorGUIElement_EditPropertyValue_BuiltIn<IntRange>
    {
        ...
        public EditorGUIElement_EditPropertyValue_BuiltIn_IntRange(EditProperty_Value p) : base(p) { }
    }

	[EditorGUIElementForType(typeof(FloatRange), true)]
    public class EditorGUIElement_EditPropertyValue_BuiltIn_FloatRange : EditorGUIElement_EditPropertyValue_BuiltIn<FloatRange>
    {
        ...
        public EditorGUIElement_EditPropertyValue_BuiltIn_FloatRange(EditProperty_Value p) : base(p) { }
    }
