...
namespace Crunchy.Sack
{
    ...
    public abstract class EffigyInfo_Collection_Flush_Overwrite : EffigyInfo_Collection_Flush
    {
        ...
        public EffigyInfo_Collection_Flush_Overwrite(Type r, Type c) : base(r, c)
        {
