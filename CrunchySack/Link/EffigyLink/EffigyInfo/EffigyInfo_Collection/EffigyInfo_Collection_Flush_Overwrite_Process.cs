...
namespace Crunchy.Sack
{
    ...
    static public partial class RepresentationEngineExtensions_Add
    {
        ...
        static public void AddFlushNamedChildren<REPRESENTATION_TYPE, CHILD_TYPE>(this RepresentationEngine item, string n, Process<REPRESENTATION_TYPE, IEnumerable<CHILD_TYPE>> s)
        {
