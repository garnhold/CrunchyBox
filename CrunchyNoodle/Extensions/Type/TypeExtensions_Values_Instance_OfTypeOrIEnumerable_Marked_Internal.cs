...
namespace CrunchyNoodle
{
    ...
    {
        static private OperationCache<List<FieldInfoEX>, Type> GET_MARKED_INSTANCE_FIELDS_OF_TYPE_OR_IENUMERABLE = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<MethodInfoEX>, Type> GET_MARKED_INSTANCE_METHODS_WITH_RETURN_OR_IENUMERABLE_AND_NO_EFFECTIVE_PARAMETERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<IteratorGetter<T>, Type> GET_MARKED_INSTANCE_VALUES_OF_TYPE_OR_IENUMERABLE_ITERATOR_GETTER = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
