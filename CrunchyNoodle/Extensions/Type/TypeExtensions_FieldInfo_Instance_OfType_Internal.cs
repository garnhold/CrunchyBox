...
namespace CrunchyNoodle
{
    ...
    {
        static private OperationCache<List<FieldInfoEX>, Type> GET_ALL_INSTANCE_FIELDS_OF_TYPE = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<FieldInfoEX>, Type, FieldInfoFilters> GET_FILTERED_INSTANCE_FIELDS_OF_TYPE = ReflectionCache.Get().NewOperationCache(delegate(Type item, FieldInfoFilters filters) {
        ...
        static private OperationCache<List<ValueSetter<T>>, Type, FieldInfoFilters> GET_FILTERED_INSTANCE_FIELDS_OF_TYPE_VALUE_SETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item, FieldInfoFilters filters) {
        ...
        static private OperationCache<List<ValueGetter<T>>, Type, FieldInfoFilters> GET_FILTERED_INSTANCE_FIELDS_OF_TYPE_VALUE_GETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item, FieldInfoFilters filters) {
            return item.GetFilteredInstanceFieldsOfType<T>(filters)
        ...
        static private OperationCache<IteratorGetter<T>, Type, FieldInfoFilters> GET_FILTERED_INSTANCE_FIELDS_OF_TYPE_ITERATOR_GETTER = ReflectionCache.Get().NewOperationCache(delegate(Type item, FieldInfoFilters filters) {
