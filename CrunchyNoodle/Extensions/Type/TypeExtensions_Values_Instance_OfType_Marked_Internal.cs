...
namespace CrunchyNoodle
{
    ...
    {
        static private OperationCache<List<FieldInfoEX>, Type> GET_MARKED_INSTANCE_FIELDS_OF_TYPE = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<ValueGetter<T>>, Type> GET_MARKED_INSTANCE_FIELDS_OF_TYPE_VALUE_GETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<ValueSetter<T>>, Type> GET_MARKED_INSTANCE_FIELDS_OF_TYPE_VALUE_SETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
            return GetMarkedInstanceFieldsOfType(item)
        ...
        static private OperationCache<List<MethodInfoEX>, Type> GET_MARKED_INSTANCE_METHODS_WITH_RETURN_AND_NO_EFFECTIVE_PARAMETERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<ValueGetter<T>>, Type> GET_MARKED_INSTANCE_METHODS_WITH_RETURN_AND_NO_EFFECTIVE_PARAMETERS_VALUE_GETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<MethodInfoEX>, Type> GET_MARKED_INSTANCE_METHODS_WITHOUT_RETURN_AND_PARAMETER_OF_TYPE = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
            return item.GetFilteredInstanceMethods(
        ...
        static private OperationCache<List<ValueSetter<T>>, Type> GET_MARKED_INSTANCE_METHODS_WITHOUT_RETURN_AND_PARAMETER_OF_TYPE_VALUE_SETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<ValueSetter<T>>, Type> GET_MARKED_INSTANCE_VALUES_OF_TYPE_VALUE_SETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
        ...
        static private OperationCache<List<ValueGetter<T>>, Type> GET_MARKED_INSTANCE_VALUES_OF_TYPE_VALUE_GETTERS = ReflectionCache.Get().NewOperationCache(delegate(Type item) {
