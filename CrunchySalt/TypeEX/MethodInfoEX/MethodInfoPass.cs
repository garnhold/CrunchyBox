...
namespace Crunchy.Salt
{
    ...
    public abstract class MethodInfoPass : MethodInfo, ForeignMethodInfo
    {
        ...
        //public override Delegate CreateDelegate(Type delegateType) { return GetNativeMethodInfo().CreateDelegate(delegateType); }
        //public override Delegate CreateDelegate(Type delegateType, object target) { return GetNativeMethodInfo().CreateDelegate(delegateType, target); }
        ...
        //public override bool IsSecurityCritical { get { return GetNativeMethodInfo().IsSecurityCritical; } }
        //public override bool IsSecuritySafeCritical { get { return GetNativeMethodInfo().IsSecuritySafeCritical; } }
        //public override bool IsSecurityTransparent { get { return GetNativeMethodInfo().IsSecurityTransparent; } }
        public override RuntimeMethodHandle MethodHandle { get { return GetNativeMethodInfo().MethodHandle; } }
        //public override MethodImplAttributes MethodImplementationFlags { get { return GetNativeMethodInfo().MethodImplementationFlags; } }
        ...
        //MemberInfo
        //public override IEnumerable<CustomAttributeData> CustomAttributes { get { return GetNativeMethodInfo().CustomAttributes; } }
        ...
        //public override IList<CustomAttributeData> GetCustomAttributesData() { return GetNativeMethodInfo().GetCustomAttributesData(); }
