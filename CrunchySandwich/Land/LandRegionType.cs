...
namespace CrunchySandwich
{
    ...
    public class LandRegionType : CustomAsset
    {
        ...
        public bool BuildLandRegion(Land land, Grid<LandPoint> grid)
        {
            if(builder != null)
        ...
        public void PaintLandRegion(Land land, Grid<LandPoint> grid)
        {
            if(painter != null)
                painter.PaintLandRegion(land, this, grid);
        }

        public void PopulateLandRegion(Land land, Grid<LandPoint> grid, GameObject parent)
        {
            if(populater != null)
