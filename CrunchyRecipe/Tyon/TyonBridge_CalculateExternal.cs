...
namespace CrunchyRecipe
{
    ...
    {
        protected abstract object CalculateAddress(VariableInstance variable, TyonContext_Dehydration context);
        ...
        {
            return new TyonValue_ExternalAddress(CalculateAddress(variable, context), context);
        }
